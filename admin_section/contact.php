    ...
    <div class="box_general p-3">
        <div class="list_general">
            <ul>
                ...
                <div class="form-group">
                  <label>Email</label>
                    <input type="email" class="form-control" id="brandname" aria-describedby="emailHelp" name="email" value="<?php
                      $get_details=mysqli_query($conn, "SELECT * FROM contact");
                      $row_details=mysqli_fetch_array($get_details);
                      echo $row_details['email'];
...
<?php
        ...
        $sql = "UPDATE contact SET heading='$_POST[heading]', sub_heading='$_POST[sub_heading]', email='$_POST[email]'";
