            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-9">
                    <div class="section-heading text-center mb-5">
                        <h4>Search Results for: <span class="text-danger"><?php echo ucfirst($_GET['search']) ; ?></span></h4>
                        <!-- <p class="lead">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                if(isset($_GET["page"])){
                                ...
                                $item_per_page  = 12;
                                $page_url       = 'http://localhost/landing_page/result?'.'search='.$search.'&'.'submit=search.';
                                $count_pages = $conn->query("SELECT COUNT(*) FROM products WHERE `product_keywords` like '%$search%'");
               ...
               <?php 
                    $get_product=mysqli_query($conn, "SELECT * FROM `products` WHERE `product_keywords` like '%$search%' ORDER BY product_id DESC LIMIT $page_position, $item_per_page");
                    $count_product = mysqli_num_rows($get_product);
                    if ($count_product>0) {
                            ...
                            <div class="promo-info">
                                <h5 class="container">
                                    <?php echo ucfirst($row['product_title']); ?><br><strong style="color: red; font-size: 16px"> &#8358
                                        ...
                                        <br><strike class="text-muted" style="font-size: 14px"> <?php if ($row['aproduct_price']==0) {
                                            echo "";
                                        }else{ ?> 
                                            &#8358
               ...
               <?php }else { ?>
                <div class="text-center">
                    <img src="img/opps.png" class="img-fluid w-25">
                    <p style="font-size: 23px" class="text-danger">No results Found</p>
                </div>
              <?php } ?>
            </div>
        </div>
